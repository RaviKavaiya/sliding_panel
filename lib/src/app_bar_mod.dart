/// This is just a modified version of 'app_bar.dart', that accepts a custom
/// 'titleHeight' parameter, that allows the AppBar (and SliverAppBar) to have
/// any height we want.
...
/// app bar, see [SlidingPanelSliverAppBar], which embeds an [SlidingPanelAppBar] in a sliver for use in
/// a [CustomScrollView].
///
...
///
/// If the [leading] widget is omitted, but the [SlidingPanelAppBar] is in a [Scaffold] with
...
///
/// This sample shows an [SlidingPanelAppBar] with two simple actions. The first action
...
/// See also:
///
///  * [Scaffold], which displays the [SlidingPanelAppBar] in its [Scaffold.appBar] slot.
///  * [SlidingPanelSliverAppBar], which uses [SlidingPanelAppBar] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [SlidingPanelAppBar]
...
class SlidingPanelAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  SlidingPanelAppBar({
    ...
    this.bottomOpacity = 1.0,
        ...
        preferredSize = Size.fromHeight(
            titleHeight + (bottom?.preferredSize?.height ?? 0.0)),
        super(key: key);

  /// A widget to display before the [title].
  ///
  /// If this is null and [automaticallyImplyLeading] is set to true, the
  /// [SlidingPanelAppBar] will imply an appropriate widget. For example, if the [SlidingPanelAppBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [SlidingPanelAppBar]
  ...
  /// See also:
  ///
  ///  * [Scaffold.appBar], in which an [SlidingPanelAppBar] is usually placed.
  ...
  ///
  /// A flexible space isn't actually flexible unless the [SlidingPanelAppBar]'s container
  /// changes the [SlidingPanelAppBar]'s size. A [SlidingPanelSliverAppBar] in a [CustomScrollView]
  /// changes the [SlidingPanelAppBar]'s height when scrolled.
  ///
  ...
  /// used by [SlidingPanelSliverAppBar] to animate the opacity of the toolbar when the app
  /// bar is scrolled.
  ...
  @override
  _SlidingPanelAppBarState createState() => _SlidingPanelAppBarState();
}

class _SlidingPanelAppBarState extends State<SlidingPanelAppBar> {
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  double get minExtent =>
      collapsedHeight ?? (topPadding + titleHeight + _bottomHeight);

  @override
  double get maxExtent => max(
      topPadding + (expandedHeight ?? titleHeight + _bottomHeight), minExtent);
  ...
  Widget build(
    ...
    final double toolbarOpacity = !pinned || (floating && bottom != null)
        ? ((visibleMainHeight - _bottomHeight) / titleHeight).clamp(0.0, 1.0)
            as double
        : 1.0;
...
/// the screen see [SlidingPanelAppBar], which is used in the [Scaffold.appBar] slot.
///
...
/// See also:
///
///  * [CustomScrollView], which integrates the [SlidingPanelSliverAppBar] into its
///    scrolling.
///  * [SlidingPanelAppBar], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [SlidingPanelAppBar]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
///    can expand and collapse.
///  * <https://material.io/design/components/app-bars-top.html>
class SlidingPanelSliverAppBar extends StatefulWidget {
  /// Creates a material design app bar that can be placed in a [CustomScrollView].
  ///
  /// The arguments [forceElevated], [primary], [floating], [pinned], [snap]
  /// and [automaticallyImplyLeading] must not be null.
  const SlidingPanelSliverAppBar({
    Key key,
    this.leading,
    this.automaticallyImplyLeading = true,
    this.title,
  ...
  /// A widget to display before the [title].
  ///
  /// If this is null and [automaticallyImplyLeading] is set to true, the [SlidingPanelAppBar] will
  /// imply an appropriate widget. For example, if the [SlidingPanelAppBar] is in a [Scaffold]
  ...
  /// [Navigator] can go back, the [SlidingPanelAppBar] will use a [BackButton] that calls
  /// [Navigator.maybePop].
  final Widget leading;
  ...
  /// content is not scrolled under the [SlidingPanelAppBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [SlidingPanelAppBar] is being displayed over content that is scrolled under it.
  ///
  ...
  /// See also:
  ///
  ///  * [SlidingPanelSliverAppBar] for more animated examples of how this property changes the
  ...
  @override
  _SlidingPanelSliverAppBarState createState() =>
      _SlidingPanelSliverAppBarState();
}
