...
class PanelScrollData {
  ...
  ///
  /// This is exactly the same controller used in the [PanelContent] (You also get its reference when you build the panel).
  ...
  /// Whether the scrollable content is at its starting position (i.e., scrolled to end).
  bool get atEnd {
    if (scrollController.position.atEdge) {
      if (scrollController.position.pixels ==
